---
slug: graphql-graphql-databases-prisma
id: graphql-07
track: graphql
order: 7
...
# GraphQL with Databases (Prisma)

## GraphQL with Databases (Prisma)

### Why It Matters

This lesson covers graphql with databases (prisma). Understanding this is essential for real-world proficiency and is commonly asked in technical interviews.

Connect GraphQL to a database using Prisma ORM.
...
Build a small project that demonstrates graphql with databases (prisma).
