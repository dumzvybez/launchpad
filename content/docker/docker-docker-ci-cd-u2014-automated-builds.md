---
slug: docker-docker-ci-cd-u2014-automated-builds
id: docker-09
track: docker
order: 9
...
# Docker in CI/CD — Automated Builds

## Docker in CI/CD — Automated Builds

### Why It Matters

This lesson covers docker in ci/cd — automated builds. Understanding this is essential for real-world proficiency and is commonly asked in technical interviews.

Automate Docker image builds in GitHub Actions and GitLab CI.
...
Build a small project that demonstrates docker in ci/cd — automated builds.
