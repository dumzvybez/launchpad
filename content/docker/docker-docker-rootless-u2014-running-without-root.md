---
slug: docker-docker-rootless-u2014-running-without-root
id: docker-13
track: docker
order: 13
...
# Docker Rootless — Running Without Root

## Docker Rootless — Running Without Root

### Why It Matters

This lesson covers docker rootless — running without root. Understanding this is essential for real-world proficiency and is commonly asked in technical interviews.

Run Docker daemon as a non-root user for enhanced security.
...
Build a small project that demonstrates docker rootless — running without root.
