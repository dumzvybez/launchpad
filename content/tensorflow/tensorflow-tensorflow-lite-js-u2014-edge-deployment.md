---
slug: tensorflow-tensorflow-lite-js-u2014-edge-deployment
id: tensorflow-05
track: tensorflow
order: 5
...
# TensorFlow Lite & JS — Edge Deployment

## TensorFlow Lite & JS — Edge Deployment

### Why It Matters

This lesson covers tensorflow lite & js — edge deployment. Understanding this is essential for real-world proficiency and is commonly asked in technical interviews.

Deploy models to mobile (TFLite) and browser (TFJS).
...
Build a small project that demonstrates tensorflow lite & js — edge deployment.
