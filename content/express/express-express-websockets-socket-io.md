---
slug: express-express-websockets-socket-io
id: express-09
track: express
order: 9
...
# Express WebSockets (Socket.io)

## Express WebSockets (Socket.io)

### Why It Matters

This lesson covers express websockets (socket.io). Understanding this is essential for real-world proficiency and is commonly asked in technical interviews.

Add real-time communication to Express with Socket.io.
...
Build a small project that demonstrates express websockets (socket.io).
