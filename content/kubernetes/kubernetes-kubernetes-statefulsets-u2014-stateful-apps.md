---
slug: kubernetes-kubernetes-statefulsets-u2014-stateful-apps
id: kubernetes-06
track: kubernetes
order: 6
...
# Kubernetes StatefulSets — Stateful Apps

## Kubernetes StatefulSets — Stateful Apps

### Why It Matters

This lesson covers kubernetes statefulsets — stateful apps. Understanding this is essential for real-world proficiency and is commonly asked in technical interviews.

Deploy stateful applications (databases) with StatefulSets and persistent storage.
...
Build a small project that demonstrates kubernetes statefulsets — stateful apps.
