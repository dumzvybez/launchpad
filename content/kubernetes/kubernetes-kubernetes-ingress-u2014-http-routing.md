---
slug: kubernetes-kubernetes-ingress-u2014-http-routing
id: kubernetes-08
track: kubernetes
order: 8
...
This lesson covers kubernetes ingress — http routing. Understanding this is essential for real-world proficiency and is commonly asked in technical interviews.

Route HTTP traffic to services with Ingress controllers and rules.
...
Build a small project that demonstrates kubernetes ingress — http routing.
